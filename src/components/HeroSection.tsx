  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative w-full bg-black z-0 overflow-hidden" style={{ marginTop: 0 }}>
      ...
      <div className="w-full bg-black/90 overflow-hidden relative z-20 px-2 sm:px-4 py-2">
        <div
          className="animate-infinite-scroll whitespace-nowrap font-semibold text-white text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl"
          style={{
