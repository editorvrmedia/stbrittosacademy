          ...
          <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 mt-2">Enter your credentials to access the parent portal</p>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <p className="text-center text-sm text-gray-600">
                  ...
                  <a href="/contact" className="text-slate-600 hover:text-slate-700 font-medium">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">Everything you need to stay connected with your child's education</p>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">{studentData.grade} • ID: {studentData.studentId}</p>
                <p className="text-gray-600">{studentData.homeroom}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
                <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                  <BookOpen className="h-6 w-6 mr-3 text-slate-600" />
                  Recent Grades
                </h3>
